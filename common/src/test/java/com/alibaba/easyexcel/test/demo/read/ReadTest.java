...
public class ReadTest {
    ...
    public void simpleRead() {
        ...
        // 写法1：
        String fileName = TestFileUtil.getPath() + "com/alibaba/easyexcel/test/demo" + File.separator + "com.alibaba.easyexcel.test.demo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
        EasyExcel.read(fileName, DemoData.class, new DemoDataListener()).sheet().doRead();

        // 写法2：
        fileName = TestFileUtil.getPath() + "com/alibaba/easyexcel/test/demo" + File.separator + "com.alibaba.easyexcel.test.demo.xlsx";
    ...
    public void extraRead() {
        String fileName = TestFileUtil.getPath() + "com/alibaba/easyexcel/test/demo" + File.separator + "extra.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
    ...
    public void cellDataRead() {
        String fileName = TestFileUtil.getPath() + "com/alibaba/easyexcel/test/demo" + File.separator + "cellDataDemo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
