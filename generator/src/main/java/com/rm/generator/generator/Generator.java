...
//                contentBuffer.append(methodBuffer);
    ...
    private static void generateRepository() {
        try {
            ...
            while (resultSet.next()) {
                ...
                //创建mapper文件
                if (getRepositorySavePath() == null) break;
                String targetFile = getRepositorySavePath() + domainName + "Repository.java";
                ...
                Template t = ve.getTemplate("template/repository.template", "UTF-8");
    ...
    private static String getRepositorySavePath() {
        return getSavePath(daoPackage + ".repository");
    }
