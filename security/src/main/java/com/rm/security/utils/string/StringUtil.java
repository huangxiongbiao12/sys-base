package com.rm.security.utils.string;
...
public class StringUtil extends StringUtilParent {
     ...
     * @return
     */
    public static String columnName2AttrName(String columnName) {
    ...
    public static String excelError(Integer rowNum, String headerName, String message) {
        return "第" + rowNum + "行" + "【" + headerName + "】" + message;
    }
