...
import com.rm.security.utils.validate.ValidateUtils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static final SimpleDateFormat SHORTDATEFORMAT = new SimpleDateFormat(PATTERN_yyyyMMdd);
    public static final SimpleDateFormat SHORT_DATE_FORMAT = new SimpleDateFormat(PATTERN_yyyy_MM_dd);
    ...
    public static void main(String[] args) {
        ...
        Date date1 = DateUtils.addMinute(new Date(), -1);
        Date date2 = DateUtils.addMinute(date1, 5);
